...
#define CONFIGURATION_H_VERSION 20190719 // by Luiz Marangoni
...
#define STRING_CONFIG_H_AUTHOR "Luiz Marangoni" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "NuRIA 3D"
...
#define TEMP_RESIDENCY_TIME 5   // (seconds) //valor padrao 10
#define TEMP_HYSTERESIS 5       // (degC) range of +/- temperatures considered "close" to the target one //valor padrao 3
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define DEFAULT_Ki 0.06
  //#define DEFAULT_Kd 78.34
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
   ...
   #define  DEFAULT_bedKi 78.99
   #define  DEFAULT_bedKd 516.05
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80,80,4000,500 }//LCMO - corrigindo bug 2802
 ...
 */
 //Linha abaixo comentada por conta do uso do BLTOUCH
...
//Obtido do site:
//https://reprap.org/wiki/How_to_Add_Auto_Bed_Leveling_Sensor_to_Geeetech_Prusa_I3_3D_Printer_DIY_Kit#Mechanical
 ...
 */
  ...
  #define PROBE_PT_1_X 10       // Probing points for 3-Point leveling of the mesh
